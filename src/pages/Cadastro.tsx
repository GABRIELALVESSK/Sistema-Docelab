            ...
            <div className="w-full max-w-md relative z-10">
                ...
                <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl shadow-black/5 border border-white/60 p-8">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="w-full flex items-center justify-center gap-3 bg-white border border-gray-200 text-gray-700 font-bold py-3.5 mb-5 rounded-2xl hover:bg-gray-50 hover:border-gray-300 transition-all shadow-sm disabled:opacity-70 disabled:cursor-not-allowed"
                    >

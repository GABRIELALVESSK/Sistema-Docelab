    ...
    <div className="w-full flex h-full overflow-hidden">
        ...
        <div className="mb-8">
              ...
              <DropdownMenuContent align="end" className="w-48 rounded-2xl p-2 shadow-xl border-gray-100">
                {Array.from({ length: 12 }).map((_, i) => {
                  ...
                  return (
                    <DropdownMenuItem
                      key={i}
                      className="rounded-xl font-bold text-[12px] uppercase tracking-wider py-3 cursor-pointer"
          ...
          <div className="flex items-end justify-between h-32 gap-3 pt-2">
            {[
              ...
              return (
                <div key={i} className="flex flex-col items-center gap-3 group w-full">
                  <div className="w-full bg-gray-100 dark:bg-gray-800 rounded-xl relative h-28 flex items-end justify-center overflow-hidden border border-gray-200/50 dark:border-gray-700">
                    <div
                      className="absolute bottom-0 w-full rounded-b-xl rounded-t-sm bg-emerald-400 transition-all duration-500"
                      style={{ height: `${percent > 0 ? Math.max(percent, 4) : 0}%` }}
                    ></div>
                  </div>
                  <span className="text-[12px] font-black uppercase tracking-widest text-gray-500 group-hover:text-emerald-500 transition-colors">{d.day}</span>
                </div>
              );
            })}
            <div className="flex flex-col items-center justify-center ml-4 shrink-0">
              ...
              <span className="text-[12px] font-black uppercase tracking-widest text-gray-500">Média Diária</span>
              <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 mt-2 shadow-glow animate-pulse"></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:flex w-[380px] p-6 flex-col border-l border-gray-100 bg-white z-10 overflow-hidden custom-scrollbar">
        <div className="flex justify-end gap-6 mb-6">
            ...
            <DropdownMenuContent align="end" className="w-64 rounded-2xl p-2 shadow-xl border-gray-100 bg-white">
              ...
              {entregas.map((entrega, i) => (
                ...
                >
                  <div className="flex justify-between w-full items-center">
                    <span className="text-[13px] font-bold text-indigo-500 uppercase tracking-tighter">Próxima Entrega</span>
              ...
              <div className="p-2 mt-2 border-t border-gray-50">
                <button
                  ...
                  className="w-full text-center py-2 text-[13px] font-black uppercase tracking-widest text-gray-500 hover:text-gray-600 transition"
                >
          ...
          <button onClick={() => toast({ title: "Agenda", description: `Visualizando agenda de ${format(currentDate, "MMMM", { locale: ptBR })}` })} className="text-gray-500 hover:text-gray-600 transition">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-5 group cursor-pointer">
              ...
              <div className="flex flex-col items-end gap-1">
                ...
                <span className="text-[13px] font-black text-gray-500 uppercase">Now</span>
              </div>
            </div>
            <div className="flex items-center gap-5 group cursor-pointer" onClick={() => navigate('/orcamentos')}>
              ...
              <div className="flex flex-col items-end gap-1">
                <span className="material-icons-round text-gray-200 text-sm">schedule</span>
                <span className="text-[13px] font-black text-gray-500 uppercase">2h</span>
              </div>
            </div>
            <div className="flex items-center gap-5 group cursor-pointer" onClick={() => navigate('/financas')}>
              ...
              <div className="flex flex-col items-end gap-1">
                <span className="material-icons-round text-gray-200 text-sm">schedule</span>
                <span className="text-[13px] font-black text-gray-500 uppercase">1d</span>
              </div>
            </div>
          </div>
        </div>

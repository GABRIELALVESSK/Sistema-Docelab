...
export default function Caixa() {
    ...
    return (
        <div className="p-4 h-full overflow-hidden animate-in-fade bg-[#F5F1EB] dark:bg-background-dark relative">
            <div className="bg-white dark:bg-card-dark w-full h-full rounded-[2.5rem] shadow-soft overflow-y-auto p-8 relative">
                ...
                <header className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
                    <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-xl bg-pink-100/50 dark:bg-pink-900/20 text-[#F87171] flex items-center justify-center shadow-sm">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="bg-[#FEF7F8] dark:bg-gray-800/50 rounded-2xl p-6 relative overflow-hidden group hover:shadow-md transition-shadow border border-[#FDA4AF]/10 dark:border-gray-700">
                        <div className="absolute -right-4 -top-4 w-24 h-24 bg-[#FDA4AF]/10 dark:bg-[#FDA4AF]/5 rounded-full blur-2xl group-hover:bg-[#FDA4AF]/20 dark:group-hover:bg-[#FDA4AF]/10 transition-all"></div>
                        <div className="flex items-center gap-2 mb-2 relative z-10">
                            <div className="bg-white/50 dark:bg-gray-800 p-1 rounded-md">
                    ...
                    <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 relative overflow-hidden group hover:shadow-md transition-shadow">
                        <div className="flex items-center gap-2 mb-2">
                            <div className="bg-green-50 dark:bg-green-900/20 p-1 rounded-md">
                                <TrendingUp className="w-4 h-4 text-[#10B981]" />
                            </div>
                            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Total de Entradas</span>
                        </div>
                    ...
                    <div className="bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 rounded-2xl p-6 relative overflow-hidden group hover:shadow-md transition-shadow">
                        <div className="flex items-center gap-2 mb-2">
                            <div className="bg-red-50 dark:bg-red-900/20 p-1 rounded-md">
                                <TrendingDown className="w-4 h-4 text-[#EF4444]" />
                            </div>
                            <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Total de Saídas</span>
                        </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        <div className="bg-white dark:bg-card-dark rounded-2xl border border-gray-100 dark:border-gray-800 p-6 shadow-soft">
                            <div className="flex items-center gap-2 mb-6">
                                <Wallet className="w-5 h-5 text-gray-500" />
                                <h3 className="font-bold text-lg text-gray-900 dark:text-white">Resumo por Método</h3>
                            </div>

                            <div className="bg-gray-100 dark:bg-gray-800 p-1 rounded-xl flex mb-6 border dark:border-gray-700">
                                <button
                                    onClick={() => setActiveTab("entradas")}
                                    className={cn(
                                        "flex-1 py-2 px-4 rounded-lg text-sm font-semibold flex items-center justify-center gap-2 transition-all",
                                        activeTab === "entradas" ? "bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm" : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
                                    )}
                                >
                                ...
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        activeTab === "saidas" ? "bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm" : "text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
                                    )}
                                >
                                ...
                                {resumoMetodos.length === 0 ? (
                                    ...
                                    >
                                        <div className="flex items-center gap-3">
                                            ...
                                            <span className="font-semibold text-gray-800 dark:text-gray-200">{item.metodo}</span>
                                        </div>
                    ...
                    <div className="lg:col-span-8">
                        <div className="bg-white dark:bg-card-dark rounded-2xl border border-gray-100 dark:border-gray-800 p-6 lg:p-8 shadow-soft h-full">
                            {metodoAtivo ? (
                                <>
                                    <div className="flex flex-col sm:flex-row sm:items-start justify-between mb-8 pb-8 border-b border-gray-100 dark:border-gray-800 gap-6">
                                        <div>
                                            <div className="flex items-center gap-3 mb-2">
                                                <PiggyBank className="w-5 h-5 text-gray-500" />
                                                <h3 className="font-bold text-lg text-gray-900 dark:text-white">Saldo por Método de Pagamento</h3>
                                            </div>
                                            <div className="flex items-center gap-4 mt-6">
                                                ...
                                                <div>
                                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">{metodoAtivo.metodo}</h2>
                                                    <p className="text-sm text-gray-500 dark:text-gray-400">{metodoAtivo.transacoes.length} transações</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="bg-gray-50 dark:bg-gray-800 border-gray-100 dark:border-gray-700 rounded-xl p-4 min-w-[200px] border">
                                            ...
                                            <div className="flex items-center justify-between mt-4 text-sm">
                                                ...
                                                <div className="h-8 w-px bg-gray-200 dark:bg-gray-700 mx-3"></div>
                                                <div>
                                    ...
                                    <div>
                                        ...
                                        <div className="space-y-3">
                                            {metodoAtivo.transacoes.slice(0, 10).map((t) => (
                                                <div key={t.id} className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl group hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors cursor-default border border-transparent hover:border-gray-200 dark:hover:border-gray-700">
                                                    <div className="flex items-center gap-4">
                                                        <div className={cn(
                                                            "w-8 h-8 rounded-full flex items-center justify-center shadow-sm border border-gray-100 dark:border-gray-700",
                                                            t.tipo === "receita" ? "bg-white dark:bg-gray-700 text-[#10B981]" : "bg-white dark:bg-gray-700 text-[#EF4444]"
                                                        )}>
                                                            {t.tipo === "receita" ? <Plus className="w-4 h-4" /> : <Plus className="w-4 h-4 rotate-45" />}
                                                        </div>
                                                        <div>
                                                            <p className="text-sm font-semibold text-gray-800 dark:text-gray-200">{t.descricao}</p>
                                                    ...
                                                    <div className="text-right">
                                                        ...
                                                        <p className="text-xs text-gray-500 dark:text-gray-400">{format(parseISO(t.data), "dd/MM")}</p>
                                                    </div>
                                                </div>
                                            ))}
                                            <div className="pt-4 flex justify-center">
                                                <button className="text-xs font-semibold text-gray-500 dark:text-gray-400 hover:text-[#F87171] dark:hover:text-[#F87171] transition-colors flex items-center gap-1 group">
                                ...
                                <div className="flex flex-col items-center justify-center h-full py-20 opacity-40">
                                    <Wallet className="w-16 h-16 text-gray-500 dark:text-gray-400 mb-4" />
                                    <h3 className="text-lg font-bold text-gray-700 dark:text-gray-300">Sem dados detalhados</h3>
